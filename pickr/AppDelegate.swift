...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationWillFinishLaunching(_ aNotification: Notification) {
        // URL event handler logic taken from these sources, thanks a lot!
        //   http://stackoverflow.com/questions/24080210/how-to-capture-the-url-used-to-launch-an-osx-application-via-urlscheme-in-swift
        //   http://stackoverflow.com/questions/1991072/how-to-handle-with-a-default-url-scheme
        //   http://fredandrandall.com/blog/2011/07/30/how-to-launch-your-macios-app-with-a-custom-url/
        //   https://github.com/mattdonnelly/Swifter/blob/master/SwifterDemoMac/AppDelegate.swift
        //   http://techblog.amphora-research.com/2010/03/registering-url-handlers-in-macos-x-cocoa-apps/
        let eventManager = NSAppleEventManager.shared()
        eventManager.setEventHandler(self,
                                     andSelector: #selector(
                                        AppDelegate.handleGetURLEvent(_:withReplyEvent:)
                                     ),
                                     forEventClass: AEEventClass(kInternetEventClass),
                                     andEventID: AEEventID(kAEGetURL))

        // registers this app as a default handler for pickr://.. URLs (i think:)
        //LSSetDefaultHandlerForURLScheme("pickr" as CFString, Bundle.main.bundleIdentifier! as CFString)
    }
    ...
    func application(_ sender: NSApplication, openFile filename: String) -> Bool {
        openURLAndTerminate(filename, withBrowser: "TorBrowser")
        return true
    }
    ...
    func openDefaultBrowserAndTerminateApp() {
        // thanks a lot to:
    ...
    func openBrowserAndTerminateApp(_ browser: String) {
        openURLAndTerminate(url, withBrowser: browser)
    }

    func openURLAndTerminate(_ url: String, withBrowser browser: String) {

        let task = Process()
        task.launchPath = "/usr/bin/open"
        task.arguments = ["-a", browser, url]
        task.launch()
...
// boilerplate code generated by XCode, which we don't need at the moment:
